...
```sh
bunx github:lennox-davidlevy/instructor-agent#v1.0.7
```
...
bunx github:lennox-davidlevy/instructor-agent#v1.0.7 --dry-run

# Refresh everything to the latest versions
bunx github:lennox-davidlevy/instructor-agent#v1.0.7 --force
