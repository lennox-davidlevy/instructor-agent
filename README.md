...
```sh
bunx github:lennox-davidlevy/instructor-agent#v1.0.4
```
...
bunx github:lennox-davidlevy/instructor-agent#v1.0.4 --dry-run

# Refresh everything to the latest versions
bunx github:lennox-davidlevy/instructor-agent#v1.0.4 --force
