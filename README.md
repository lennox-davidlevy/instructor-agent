...
```sh
bunx github:lennox-davidlevy/instructor-agent#v1.0.2
```
...
bunx github:lennox-davidlevy/instructor-agent#v1.0.2 --dry-run

# Refresh everything to the latest versions
bunx github:lennox-davidlevy/instructor-agent#v1.0.2 --force
