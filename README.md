...
```sh
bunx github:lennox-davidlevy/instructor-agent#v1.0.6
```
...
bunx github:lennox-davidlevy/instructor-agent#v1.0.6 --dry-run

# Refresh everything to the latest versions
bunx github:lennox-davidlevy/instructor-agent#v1.0.6 --force
